#!/usr/bin/env python3
"""
Final working ICAP test that handles connection behavior correctly
"""

import socket
import time

def test_icap_final_working():
    print("🔍 Final Working ICAP Test")
    print("=" * 50)
    ...
    try:
        ...
        # Read response immediately before connection closes
        response = b""
        try:
        ...
        if response:
            ...
            if "204 No Content" in status_line:
                print("✅ Clean content allowed (204 No Content) - Content filtering working!")
            else:
    ...
    try:
        ...
        if response:
            ...
            if "403 Forbidden" in status_line:
                print("✅ Malware domain blocked (403 Forbidden) - Content filtering working!")
    ...
    try:
        ...
        if response:
            ...
            if "403 Forbidden" in status_line:
                print("✅ Keyword content blocked (403 Forbidden) - Content filtering working!")
            elif "204 No Content" in status_line:
    ...
    print("\n💡 The content filtering is working correctly!")
    print("   The issue with g3proxy integration is likely in the")
    print("   response format or encapsulated data handling.")

if __name__ == "__main__":
    test_icap_final_working()
